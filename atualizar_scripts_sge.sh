...
if [ -d /var/docker/$SCRIPTS/$NOME_PASTA ]; then
    cp -r /var/docker/$SCRIPTS/$NOME_PASTA /var/docker/$TRUNK/www/.$NOME_PASTA
...
if [ -d /var/docker/$SCRIPTS/$NOME_PASTA ]; then
    cp -r /var/docker/$SCRIPTS/$NOME_PASTA /var/docker/$BETA/www/.$NOME_PASTA
...
if [ -d /var/docker/$SCRIPTS/$NOME_PASTA ]; then
    cp -r /var/docker/$SCRIPTS/$NOME_PASTA /var/docker/$STABLE/www/.$NOME_PASTA
